# -*- coding: utf-8 -*-
"""
Created on Fri Mar  7 17:58:19 2025
...
syn_soma, stim_soma, nc_soma = create_stimulation(
    soma, 0.5, 0, 10, stim_interv, 1.5, repeat=1)
...
df.to_csv('mn_10hz_1.csv', index=False)
...
syn_presyn, stim_presyn, nc_presyn = create_stimulation(
    presyn, 0.5, 0, 10, stim_interv, 1.5, repeat=1)
syn_soma, stim_soma, nc_soma = create_stimulation(
    soma, 0.5, 0, 10, stim_interv, 1.5, repeat=1)
...
df.to_csv('mn_10hz_2.csv', index=False)
...
df.to_csv('mn_10hz_3.csv', index=False)
